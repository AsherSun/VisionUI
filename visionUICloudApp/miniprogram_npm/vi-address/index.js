...
var _cityData = __webpack_require__(1);

var _cityData2 = _interopRequireDefault(_cityData);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var resultCityData = _cityData2.default.map(function (item) {
  return {
    name: item.name,
    code: item.code,
    sub: item.sub.map(function (twoItem) {
      return {
        name: twoItem.name,
        code: twoItem.code,
        sub: twoItem.sub.filter(function (threeItem) {
...
Component({
  ...
  methods: {
    tapBtn: function tapBtn(_ref) {
      var sign = _ref.currentTarget.dataset.sign;
    ...
    prickAddressChange: function prickAddressChange(_ref2) {
      var _ref2$detail$value = _ref2.detail.value,
          a = _ref2$detail$value[0],
          b = _ref2$detail$value[1],
          c = _ref2$detail$value[2];
    ...
    _setInitCity: function _setInitCity() {
      this.setData({
